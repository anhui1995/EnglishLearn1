...
import xin.xiaoa.englishlearn.WordDictationListAdapter.myTextListener;
import xin.xiaoa.englishlearn.WordDictationListAdapter.myItemListener;

public class WordDictationList extends Activity {

    private PreferencesUtils PreferencesUtils = new PreferencesUtils();
    ...
    void showToast() {
        Toast.makeText(WordDictationList.this, strShow, Toast.LENGTH_SHORT).show();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        mUserName = xin.xiaoa.englishlearn.PreferencesUtils.getSharePreStr(this, "username");
        mPassword = xin.xiaoa.englishlearn.PreferencesUtils.getSharePreStr(this, "pwd");
    ...
    private myItemListener mListener = new myItemListener() {
        ...
        public void myOnClick(int i, View v) {
            ...
            intent.setClass(WordDictationList.this, WordDetail.class);
    ...
    void buttonAdd() {
        Intent intent = new Intent();
        intent.setClass(WordDictationList.this, AddWord.class);
        startActivity(intent);
    }
    ...
    void buttonSearch() {
        ...
        Intent intent = new Intent();
        intent.setClass(WordDictationList.this, Search.class);
        startActivity(intent);
    }
    ...
    void buttonTest() {
        Intent intent = new Intent();
        intent.setClass(WordDictationList.this, SentenceTranslation.class);
        startActivity(intent);
    }
