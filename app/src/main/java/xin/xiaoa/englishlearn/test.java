...
import xin.xiaoa.englishlearn.fragment.GameFragment;
import xin.xiaoa.englishlearn.fragment.HomePageFragment;
import xin.xiaoa.englishlearn.fragment.MovieFragment;
import xin.xiaoa.englishlearn.fragment.MusicFragment;

import java.lang.reflect.Field;
import java.util.ArrayList;
import java.util.List;

public class test extends AppCompatActivity implements BottomNavigationBar.OnTabSelectedListener, ViewPager.OnPageChangeListener {
...
//                .setInactiveIcon(ContextCompat.getDrawable(this,R.mipmap.ic_launcher));//非选中的图片
    ...
    class MyOnLongClickListener implements View.OnLongClickListener {
        ...
        @Override
        public boolean onLongClick(View v) {
            System.out.println(" View.MyOnLongClickListener ");
            return true;
        }
    }
}
